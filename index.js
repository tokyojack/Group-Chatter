...
app.use(function(req, res, next) {
    ...
    if (req.isAuthenticated()) {
        ...
        pool.getConnection(function(err, connection) {
            ...
            var query = "SELECT groups.id, groups.title FROM users_in_group LEFT JOIN groups ON users_in_group.group_id = groups.id WHERE users_in_group.user_id=?"

            connection.query(query, [req.user.id], function(err, rows) {
                connection.release();
...
var groupRoutes = require("./routes/groupChatter/groupRoutes")(pool);
app.use("/group", groupRoutes);

var createGroupRoutes = require("./routes/groupChatter/createGroupRoutes")(pool);
